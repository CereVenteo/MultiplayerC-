...
public:
	...
	void ScoreSearcher(GameObject* go);

	void ScoreReset(GameObject* go);
...
private:
	...
	struct ClientProxy
	{
		...
		uint8 spaceship_type;
		float secondsSinceLastPacket = 0.0f;
		float secondsSinceLastUpdate = 0.0f;

		//this var indicates how many time have passed since the player died.
		float secondsSinceIdied = 0.0f;
...
private:
	...
	float secondsSinceLastUpdate_server = 0.0f;
	//////////////////////////////////////////////////////////////////////
	// State
	//////////////////////////////////////////////////////////////////////
