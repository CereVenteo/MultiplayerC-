...
void ScreenMainMenu::gui()
{
	...
	const char* spaceshipTypes[] = { "Type 0", "Type 1", "Type 2", "Type 3" };
	static const char* spaceshipTypeStr = spaceshipTypes[0];
	static uint8 spaceshipType = 0;
	if (ImGui::BeginCombo("Shotter##combo", spaceshipTypeStr)) // The second parameter is the label previewed before opening the combo.
	{
